...
message(STATUS "robot_main: 3 messages, 0 services")

set(MSG_I_FLAGS "-Irobot_main:/home/darkflamemalster/catkin_c/src/robot_main/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/darkflamemalster/catkin_c/src/robot_main/msg/sensor_flag.msg" NAME_WE)
add_custom_target(_robot_main_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "robot_main" "/home/darkflamemalster/catkin_c/src/robot_main/msg/sensor_flag.msg" ""
)

get_filename_component(_filename "/home/darkflamemalster/catkin_c/src/robot_main/msg/order.msg" NAME_WE)
add_custom_target(_robot_main_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "robot_main" "/home/darkflamemalster/catkin_c/src/robot_main/msg/order.msg" ""
)

get_filename_component(_filename "/home/darkflamemalster/catkin_c/src/robot_main/msg/key.msg" NAME_WE)
add_custom_target(_robot_main_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "robot_main" "/home/darkflamemalster/catkin_c/src/robot_main/msg/key.msg" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/robot_main)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/robot_main\")")
  # install generated code
  install(
