...
(cl:defmethod cl:initialize-instance :after ((m <key>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'key)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name communication_demo-msg:<key> is deprecated: use communication_demo-msg:key instead.")))

(cl:ensure-generic-function 'key-val :lambda-list '(m))
(cl:defmethod key-val ((m <key>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader communication_demo-msg:key-val is deprecated.  Use communication_demo-msg:key instead.")
  (key m))
