...
(cl:defmethod cl:initialize-instance :after ((m <order>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'order)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name user_order-msg:<order> is deprecated: use user_order-msg:order instead.")))

(cl:ensure-generic-function 'target_coordinate_x-val :lambda-list '(m))
(cl:defmethod target_coordinate_x-val ((m <order>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader user_order-msg:target_coordinate_x-val is deprecated.  Use user_order-msg:target_coordinate_x instead.")
...
(cl:defmethod target_coordinate_y-val ((m <order>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader user_order-msg:target_coordinate_y-val is deprecated.  Use user_order-msg:target_coordinate_y instead.")
