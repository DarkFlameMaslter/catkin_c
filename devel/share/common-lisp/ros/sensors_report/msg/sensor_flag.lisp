...
(cl:in-package sensors_report-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <sensor_flag>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'sensor_flag)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sensors_report-msg:<sensor_flag> is deprecated: use sensors_report-msg:sensor_flag instead.")))

(cl:ensure-generic-function 'flag-val :lambda-list '(m))
(cl:defmethod flag-val ((m <sensor_flag>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensors_report-msg:flag-val is deprecated.  Use sensors_report-msg:flag instead.")
  (flag m))
